...
## Unreleased — 2026-05-21 10:00Z ([Review 83](suite-development/review-log/2026-05-21-suite-review.md#review-83--2026-05-21-1000z): AI Engineer role-domain registered + first cold-session round on bookmark-cli-manual — 2 Findings Resolved; v0.12.0; PR [#39](https://github.com/magnificentlycursed/guild-portfolio/pull/39))
...
- **[`vsdd-suite/suite-development/suite-development.md`](suite-development/suite-development.md)** [§ Dual-audience design principle](suite-development/suite-development.md#dual-audience-design-principle-review-80-finding-3) (new sub-section) — Names the three audiences (suite developers + suite users + AI agents) audit-trail artifacts serve, the triple-coding discipline (narrative + structured-fact pairs in every load-bearing claim), and the suite-side / project-side parity rule.

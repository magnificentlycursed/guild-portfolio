...
- **`Phase 6: planned — <which of the four dimensions converge and how>.`** Example: "all four dimensions; formal verification dimension established via Phase 5 formal proof harnesses on the safety-critical control-loop functions."

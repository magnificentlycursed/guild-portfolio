...
**Language and interface supplement:** The standard dimensions below assume a browser-rendered interface. For CLI projects, consult [`../../supplements/cli.md`](../../supplements/cli.md) — the CLI UX dimensions replace most of the standard dimensions below. For browser apps, also consult [`../../supplements/browser-app.md`](../../supplements/browser-app.md) for browser-specific accessibility, responsive design, and security UX concerns. (Label aligned to the [`suite-development.md`](../../suite-development/suite-development.md) § Governing standard for domain files item 5 canonical preamble form per [Review 92 Finding 1](../../suite-development/review-log/2026-05-24-suite-review.md#r92-f1); previously `**Interface type:**`. Supplements remain inline-linked per the [Review 91 Finding 2](../../suite-development/review-log/2026-05-23-suite-review.md#r91-f2) Supplements-applied discipline.)
...
Review entries are logged in per-session files at `vsdd-suite/review-log/YYYY-MM-DD-ux.md` inside the project being reviewed; the project's `vsdd-suite/FINDINGS-INDEX.md` aggregates cross-cutting findings. The optional per-domain index at `vsdd-suite/UX-REVIEW.md` activates when the project opts in via the scaffold script's `--with-per-domain-indexes` flag. See `vsdd-suite/suite-development/suite-development.md` § Governing standard for project-level review logs.

...
**Language supplement applied:** `../../../vsdd-suite/supplements/rust.md` § Technical Writer (rustdoc-coverage check per G-137) + `../../../vsdd-suite/supplements/cli.md` § Technical Writer (CLI-specific docs — `--help` output executability).

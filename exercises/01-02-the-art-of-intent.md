...
> A personal recipe collection that lets you save, search, and organize recipes
...
> A simple timer app that lets you create named timers (like "Laundry" or "Meeting in 30 min")
...
> A reading list tracker where you can add books, mark them as read, and rate them
